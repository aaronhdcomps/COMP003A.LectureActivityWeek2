...
namespace COMP003A.LectureActivityWeek2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // score = "Generic User"; will fail to compile because you are assigning a string value to an integer variable assigned as a string -enclosed in the double quotes
            score = 0; // works
